...
///
/// This generates a static map named  of parsers that can be used to parse source code in the workspace.
///
...
macro_rules! configure_parsers {
    ($parser_list_name: ident,
        ...
        pub static $parser_list_name: std::sync::LazyLock<std::collections::HashMap<&str, $crate::core::workspace::Parsers>> =
